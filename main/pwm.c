...
esp_err_t set_pwm(void)
{
    ...
    channelConfigR.gpio_num = 4;
    channelConfigR.speed_mode = LEDC_LOW_SPEED_MODE;
    ...
    channelConfigG.gpio_num = 5;
    channelConfigG.speed_mode = LEDC_LOW_SPEED_MODE;
